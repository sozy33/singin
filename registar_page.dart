...
class Regster_page extends StatefulWidget {
  const Regster_page({super.key, this.ontap});
  final Function()? ontap;
  @override
  State<Regster_page> createState() => _Regster_pageState();
}

class _Regster_pageState extends State<Regster_page> {
...
//SHOW DILOG
    ...
    try {
      if (passwordcontroler == confirmpasswordcontroler) {
        final credential =
        ...
        showerrormessg('password and confirm password are not the same');
      }
